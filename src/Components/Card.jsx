...
const Card = (prod) => {
  const { count, setCount, openDetail, setProductShow } = useContext(ShoppingCartContext );
  ...
  return (
    ...
    onClick={() => showProduct(prod.data)}>
        <figure className='relative mb-2 w-full h-4/5'>
            ...
            <img src={prod.data?.images} className='w-full h-full object-cover rounded-lg' alt='headphones' />
